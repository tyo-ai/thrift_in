...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void _placeOrder() async {
    ...
    final paymentMethodString = _selectedPayment == 0 ? 'GoPay' : _selectedPayment == 1 ? 'Transfer' : 'COD';
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const Text('Pesanan Anda sedang diproses oleh penjual.',
        ...
        child: Column(
          ...
          children: [
            ...
            _buildCard(
              ...
              child: Column(
                children: [
                  _buildPaymentOption(0, Icons.account_balance_wallet_outlined, 'GoPay / E-wallet', 'Pintar Bayarnya'),
                  const SizedBox(height: 8),
                  _buildPaymentOption(1, Icons.swap_horiz_rounded, 'Transfer Bank', 'BCA, Mandiri, BNI, BRI'),
                  const SizedBox(height: 8),
                  _buildPaymentOption(2, Icons.handshake_outlined, 'Bayar di Tempat (COD)', ''),
                ],
              ),
            ),
            const SizedBox(height: 12),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Row(
                  ...
                  children: [
                    Text('Bayar Sekarang', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
                    SizedBox(width: 8),
            ...
            const SizedBox(height: 8),
            Center(
              child: Text('🔒  Pembayaran 100% aman & terenkripsi',
              ...
              child: Column(
                ...
                children: [
                  Text(title, style: TextStyle(
                    ...
                    color: selected ? AppColors.primary : AppColors.textPrimary, height: 1.3)),
