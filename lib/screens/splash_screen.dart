...
class _SplashScreenState extends State<SplashScreen>
  ...
  void _startAnimationSequence() async {
    ...
    await _delay(const Duration(milliseconds: 2800));
    if (!mounted) return;
    _navigateToNext();
  }
                ...
                child: ScaleTransition(
                  ...
                  child: Transform.rotate(
                    ...
                    child: Container(
                      ...
                      child: const Center(child: _ThriftInLogo(size: 72)),
                    ),
                  ),
                ),
              ),
            ...
            children: [
              ...
              LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final filledWidth = (totalWidth * progress).clamp(
                    0.0,
                    totalWidth,
                  );
                        ...
                        builder: (context, _) {
                          return Row(
                            children: List.generate(3, (i) {
                              ...
                              final opacity =
                                  (math.sin(t * math.pi * 2) * 0.4 + 0.6).clamp(
                                    0.15,
                                    1.0,
                                  );
                              return Padding(
...
class _ParticlePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final p in _particles) {
      ...
      final opacity =
          (math.sin(progress * math.pi * 2 + p.x * 10) * 0.2 + p.opacity).clamp(
            0.0,
            1.0,
          );
