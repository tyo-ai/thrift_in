...
drop policy if exists "allow anon all user_fcm_tokens" on public.user_fcm_tokens;
...
drop policy if exists "allow authenticated all user_fcm_tokens" on public.user_fcm_tokens;
...
create policy "allow anon all notifications" on public.notifications
  for all to anon using (true) with check (true);
create policy "allow anon all user_fcm_tokens" on public.user_fcm_tokens
  for all to anon using (true) with check (true);
...
create policy "allow authenticated all notifications" on public.notifications
  for all to authenticated using (true) with check (true);
create policy "allow authenticated all user_fcm_tokens" on public.user_fcm_tokens
  for all to authenticated using (true) with check (true);
